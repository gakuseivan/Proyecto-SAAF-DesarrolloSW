...
public class ConsultarActivo extends JPanel implements ActionListener, ItemListener
{
...
/*	private*/ JComboBox opcion;
	private String dependencias[] =
      { "LAB ALIMENTOS", "BIBLIOTECA", "SISTEMAS", "LAB FISICA", "LAB QUIMICA", "ELECTRONICA", "MUSICA", "DEPORTES" };
      
      
		public ConsultarActivo()
		{
		opcion = new JComboBox( dependencias );
        opcion.setMaximumRowCount( 8 );
        opcion.addItemListener(this);
	...
	public void itemStateChanged(ItemEvent evento){
		if(evento.getStateChange()==ItemEvent.SELECTED)	
			areaTexto.append(""+evento.getItem());}
